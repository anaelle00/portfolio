...
const EVENTS = [
  ...
  },
  {
    ...
    title: "Polytechnique Montréal",
    titleFr: "Polytechnique Montréal",
    subtitle: "Software Engineering · GPA 3.7/4",
    subtitleFr: "Génie logiciel · GPA 3.7/4",
    description: "Algorithms, systems programming, full-stack development, and embedded systems. Dean's List.",
    descriptionFr: "Algorithmes, programmation système, développement full-stack et systèmes embarqués. Mention d'excellence.",
    location: "Montréal, QC",
    tag: "Education",
    tagFr: "Formation",
  },
